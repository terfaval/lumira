...
export const lumiraGate_v2: ImageStylePreset = {
  ...
  locks: {
    base_style: `
      stylized 2D environment illustration,
      clean but subtle linework (inked outlines), with painterly fills,
      paper-like texture, slight grain,
      flat-to-soft shading (not realistic rendering),
      muted cool blues, low contrast,
      quiet, ancient, inward-facing,
      no photorealism, no 3D render, no cinematic grading
    `.trim(),
